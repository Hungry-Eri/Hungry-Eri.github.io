...
function setBackgroundColor(color) {
    ...
    backgroundcontainer = document.getElementById("q1-container")
...
function redButtonClicked() {
    ...
    redbutton = document.getElementById("q1-btn-red")
...
function yellowButtonClicked() {
    yellowbutton = document.getElementById("q1-btn-yellow")
    yellowbutton.onclick = setBackgroundColor("#FFD166")
}
...
function greenButtonClicked() {
    greenbutton = document.getElementById("q1-btn-green")
...
function lightbButtonClicked() {
    lightbluebutton = document.getElementById("q1-btn-lightblue")
    lightbluebutton.onclick = setBackgroundColor("#118AB2")
}
document.getElementById("q1-btn-lightblue").onclick = lightbButtonClicked;
...
function blueButtonClicked() {
    bluebutton = document.getElementById("q1-btn-blue")
